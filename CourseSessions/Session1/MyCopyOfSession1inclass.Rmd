...
or "r mean(ProjectData[,which(colname(ProjectData)=="Q1_3_The.brand.of.boat.I.buy.says.a.lot.about.who.I.am"))"
<br>
3 The answer is "sum(ProjectData[,48]==1)/nrow(ProjectData)"
<br>
<br>
