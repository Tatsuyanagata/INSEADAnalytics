...
<br>#Q2 
<br>the cumulative return  round(100*sum(StockReturns[,2]),1)
<br>the average round(100*mean(StockReturns[,2]),3)
<br>the standard deviation round(100*sd(StockReturns[,2]),3)
<hr>
<hr>
